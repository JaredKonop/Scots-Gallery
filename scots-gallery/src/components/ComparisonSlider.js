...
import beforeImage from "../assets/wedding1.png"; // Replace with the path to your before image
import afterImage from "../assets/wedding2.png"; // Replace with the path to your after image

const ComparisonSlider = ({ before = beforeImage, after = afterImage }) => {
